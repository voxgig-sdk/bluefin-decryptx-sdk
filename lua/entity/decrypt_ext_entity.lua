...
local DecryptExtEntity = {}
DecryptExtEntity.__index = DecryptExtEntity


function DecryptExtEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DecryptExtEntity)
  self._name = "decrypt_ext"
  self._client = client
...
function DecryptExtEntity:get_name()
  return self._name
end


function DecryptExtEntity:make()
  local opts = {}
...
function DecryptExtEntity:data_set(args)
  if args ~= nil then
...
function DecryptExtEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DecryptExtEntity:match_set(args)
  if args ~= nil then
...
function DecryptExtEntity:match_get()
...
function DecryptExtEntity:stream(action, args, callopts)
...
---@param reqdata DecryptExtCreateData
---@param ctrl? table
---@return DecryptExt
---@return string? err
function DecryptExtEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function DecryptExtEntity:_run_op(ctx, post_done)
  local utility = self._utility
