...
local DecryptEntity = {}
DecryptEntity.__index = DecryptEntity


function DecryptEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DecryptEntity)
  self._name = "decrypt"
  self._client = client
...
function DecryptEntity:get_name()
  return self._name
end


function DecryptEntity:make()
  local opts = {}
...
function DecryptEntity:data_set(args)
  if args ~= nil then
...
function DecryptEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DecryptEntity:match_set(args)
  if args ~= nil then
...
function DecryptEntity:match_get()
...
function DecryptEntity:stream(action, args, callopts)
...
---@param reqmatch DecryptListMatch
---@param ctrl? table
---@return Decrypt[]
---@return string? err
function DecryptEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata DecryptCreateData
---@param ctrl? table
---@return Decrypt
---@return string? err
function DecryptEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function DecryptEntity:_run_op(ctx, post_done)
  local utility = self._utility
