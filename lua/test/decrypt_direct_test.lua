...
describe("DecryptDirect", function()
  it("should direct-list-decrypt", function()
    local setup = decrypt_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-decrypt", setup.live and "live" or "unit")
...
function decrypt_direct_setup(mockres)
