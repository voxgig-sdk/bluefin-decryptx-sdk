...
function runner.env_override(m)
  local live = runner.getenv("BLUEFINDECRYPTX_TEST_LIVE")
  local override = runner.getenv("BLUEFINDECRYPTX_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("BLUEFINDECRYPTX_TEST_EXPLAIN")
