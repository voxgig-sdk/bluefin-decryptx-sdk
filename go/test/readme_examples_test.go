...
const testSeed = `map[string]any{"entity": map[string]any{"decrypt": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "decrypt_ext": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "validation": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
