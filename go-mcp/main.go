// Command BluefinDecryptx-mcp is an MCP server exposing the BluefinDecryptx
// SDK as MCP tools.
//
// Two tools are registered:
//
//	BluefinDecryptx_list  — list records of an entity
//	BluefinDecryptx_load  — load a single record of an entity
//
