...
int main(void) {
  ...
  Entity* e = bluefin_decryptx_validation(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_decryptx_validation(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = validation_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_decryptx_validation(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = validation_stream(pe, "list", NULL, NULL, &perr);
