// Behavioural feature-test harness for the BluefinDecryptx SDK (C port of the
...
#ifndef BLUEFINDECRYPTX_FEATURE_HARNESS_H
#define BLUEFINDECRYPTX_FEATURE_HARNESS_H
...
#endif // BLUEFINDECRYPTX_FEATURE_HARNESS_H
