...
int main(void) {
  ...
  Entity* e = bluefin_decryptx_decrypt_ext(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_decryptx_decrypt_ext(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = decrypt_ext_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_decryptx_decrypt_ext(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = decrypt_ext_stream(pe, "list", NULL, NULL, &perr);
