...
static void test_primary_fetcher_live(void) {
  ...
  BluefinDecryptxSDK* live = bluefindecryptx_sdk_new(
...
static void test_primary_fetcher_blocked_test_mode(void) {
  BluefinDecryptxSDK* blocked = bluefindecryptx_sdk_new(
...
static void test_primary_new_sdk_smoke(void) {
  BluefinDecryptxSDK* client = bluefindecryptx_sdk_new(v_undef());
