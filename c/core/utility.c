...
// ---- SDK client-base generic helpers (Main.fragment BluefinDecryptxSDK) -------
...
voxgig_value* sdk_options_map(BluefinDecryptxSDK* sdk) { return voxgig_clone(sdk->options); }

Utility* sdk_get_utility(BluefinDecryptxSDK* sdk) { return utility_copy(sdk->utility); }

Context* sdk_get_root_ctx(BluefinDecryptxSDK* sdk) { return sdk->rootctx; }
