// BluefinDecryptx SDK — umbrella runtime header (template; BluefinDecryptx tokens
...
#ifndef BLUEFINDECRYPTX_SDK_H
#define BLUEFINDECRYPTX_SDK_H
...
typedef struct BluefinDecryptxSDK BluefinDecryptxSDK;
...
// ===========================================================================
// Error (mirrors core/error.rs BluefinDecryptxError)
// ===========================================================================

typedef struct PNError {
  char* sdk;   // "BluefinDecryptx"
...
// ===========================================================================
// Entity (vtable; mirrors core/types.rs Entity + BluefinDecryptxEntity)
// ===========================================================================
...
typedef struct EntityVT {
  ...
  // CRUD ops (BluefinDecryptxEntity). On error set *err.
...
// ===========================================================================
// SDK client (mirrors Main.fragment BluefinDecryptxSDK) — generic fields.
// ===========================================================================

struct BluefinDecryptxSDK {
  char* mode;             // "live" | "test"
  voxgig_value* options;
  Utility* utility;
...
void sdk_features_push(BluefinDecryptxSDK* sdk, Feature* f);
void sdk_features_insert(BluefinDecryptxSDK* sdk, size_t i, Feature* f);
void sdk_features_replace(BluefinDecryptxSDK* sdk, size_t i, Feature* f);

voxgig_value* sdk_options_map(BluefinDecryptxSDK* sdk); // deep clone of options
Utility* sdk_get_utility(BluefinDecryptxSDK* sdk);      // utility_copy
Context* sdk_get_root_ctx(BluefinDecryptxSDK* sdk);

// Constructors / prepare / direct are in the generated client.c:
BluefinDecryptxSDK* bluefindecryptx_sdk_new(voxgig_value* options);
BluefinDecryptxSDK* test_sdk(voxgig_value* testopts, voxgig_value* sdkopts);
voxgig_value* sdk_prepare(BluefinDecryptxSDK* sdk, voxgig_value* fetchargs, PNError** err);
voxgig_value* sdk_direct(BluefinDecryptxSDK* sdk, voxgig_value* fetchargs, PNError** err);
