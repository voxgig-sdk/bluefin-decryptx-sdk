// DecryptExt entity client (generated — mirrors the rust Entity fragment).
...
typedef struct decrypt_ext_entity {
  Entity base;            // vtable pointer (first member)
  char* name;
  BluefinDecryptxSDK* client;
  Utility* utility;
...
typedef void (*decrypt_ext_postdone_fn)(decrypt_ext_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT decrypt_ext_VT;
static const char* decrypt_ext_get_name(Entity* e);
static Entity* decrypt_ext_make(Entity* e);
static voxgig_value* decrypt_ext_data(Entity* e, voxgig_value* args);
static voxgig_value* decrypt_ext_matchv(Entity* e, voxgig_value* args);
static voxgig_value* decrypt_ext_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* decrypt_ext_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* decrypt_ext_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* decrypt_ext_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* decrypt_ext_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);

static Context* decrypt_ext_ent_ctx(decrypt_ext_entity* self) {
  return self->entctx;
}
...
Entity* decrypt_ext_entity_new(BluefinDecryptxSDK* client, voxgig_value* entopts) {
  ...
  decrypt_ext_entity* self = (decrypt_ext_entity*)calloc(1, sizeof(decrypt_ext_entity));
  self->base.vt = &decrypt_ext_VT;
  self->name = strdup("decrypt_ext");
  self->client = client;
...
static voxgig_value* decrypt_ext_run_op(decrypt_ext_entity* self, Context* ctx,
                                    decrypt_ext_postdone_fn post_done, PNError** err) {
...
voxgig_value* decrypt_ext_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  decrypt_ext_entity* self = (decrypt_ext_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, decrypt_ext_ent_ctx(self));
...
static const char* decrypt_ext_get_name(Entity* e) {
  return ((decrypt_ext_entity*)e)->name;
}
...
static Entity* decrypt_ext_make(Entity* e) {
  ...
  return decrypt_ext_entity_new(self->client, opts);
}
...
static voxgig_value* decrypt_ext_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(decrypt_ext_ent_ctx(self), "SetData");
  }
  feature_hook_util(decrypt_ext_ent_ctx(self), "GetData");
...
static voxgig_value* decrypt_ext_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(decrypt_ext_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(decrypt_ext_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}

static voxgig_value* decrypt_ext_load(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("load", "decrypt_ext");
  return NULL;
}

static voxgig_value* decrypt_ext_list(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("list", "decrypt_ext");
  return NULL;
}


static void decrypt_ext_create_postdone(decrypt_ext_entity* self, Context* ctx) {
...
static voxgig_value* decrypt_ext_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, decrypt_ext_ent_ctx(self));
  return decrypt_ext_run_op(self, ctx, decrypt_ext_create_postdone, err);
}


static voxgig_value* decrypt_ext_update(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("update", "decrypt_ext");
  return NULL;
}

static voxgig_value* decrypt_ext_remove(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("remove", "decrypt_ext");
  return NULL;
}

static const EntityVT decrypt_ext_VT = {
  decrypt_ext_get_name,
  decrypt_ext_make,
  decrypt_ext_data,
  decrypt_ext_matchv,
  decrypt_ext_load,
