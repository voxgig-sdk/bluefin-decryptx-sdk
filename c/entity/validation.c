// Validation entity client (generated — mirrors the rust Entity fragment).
...
typedef struct validation_entity {
...
typedef void (*validation_postdone_fn)(validation_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT validation_VT;
static const char* validation_get_name(Entity* e);
static Entity* validation_make(Entity* e);
static voxgig_value* validation_data(Entity* e, voxgig_value* args);
static voxgig_value* validation_matchv(Entity* e, voxgig_value* args);
static voxgig_value* validation_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* validation_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* validation_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* validation_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* validation_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);

static Context* validation_ent_ctx(validation_entity* self) {
  return self->entctx;
}
...
Entity* validation_entity_new(BluefinDecryptxSDK* client, voxgig_value* entopts) {
  ...
  validation_entity* self = (validation_entity*)calloc(1, sizeof(validation_entity));
  self->base.vt = &validation_VT;
  self->name = strdup("validation");
  self->client = client;
...
static voxgig_value* validation_run_op(validation_entity* self, Context* ctx,
                                    validation_postdone_fn post_done, PNError** err) {
...
voxgig_value* validation_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  validation_entity* self = (validation_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, validation_ent_ctx(self));
...
static const char* validation_get_name(Entity* e) {
  return ((validation_entity*)e)->name;
}
...
static Entity* validation_make(Entity* e) {
  ...
  return validation_entity_new(self->client, opts);
}
...
static voxgig_value* validation_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(validation_ent_ctx(self), "SetData");
  }
  feature_hook_util(validation_ent_ctx(self), "GetData");
...
static voxgig_value* validation_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(validation_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(validation_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}

static voxgig_value* validation_load(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("load", "validation");
  return NULL;
}

static voxgig_value* validation_list(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("list", "validation");
  return NULL;
}


static void validation_create_postdone(validation_entity* self, Context* ctx) {
...
static voxgig_value* validation_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, validation_ent_ctx(self));
  return validation_run_op(self, ctx, validation_create_postdone, err);
}


static voxgig_value* validation_update(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("update", "validation");
  return NULL;
}

static voxgig_value* validation_remove(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("remove", "validation");
  return NULL;
}
