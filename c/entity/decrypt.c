// Decrypt entity client (generated — mirrors the rust Entity fragment).
...
typedef void (*decrypt_postdone_fn)(decrypt_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT decrypt_VT;
static const char* decrypt_get_name(Entity* e);
static Entity* decrypt_make(Entity* e);
static voxgig_value* decrypt_data(Entity* e, voxgig_value* args);
static voxgig_value* decrypt_matchv(Entity* e, voxgig_value* args);
static voxgig_value* decrypt_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* decrypt_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* decrypt_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* decrypt_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* decrypt_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);

static Context* decrypt_ent_ctx(decrypt_entity* self) {
  return self->entctx;
}
...
Entity* decrypt_entity_new(BluefinDecryptxSDK* client, voxgig_value* entopts) {
  ...
  decrypt_entity* self = (decrypt_entity*)calloc(1, sizeof(decrypt_entity));
  self->base.vt = &decrypt_VT;
  self->name = strdup("decrypt");
  self->client = client;
...
static voxgig_value* decrypt_run_op(decrypt_entity* self, Context* ctx,
                                    decrypt_postdone_fn post_done, PNError** err) {
...
voxgig_value* decrypt_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  decrypt_entity* self = (decrypt_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, decrypt_ent_ctx(self));
...
static Entity* decrypt_make(Entity* e) {
  ...
  return decrypt_entity_new(self->client, opts);
}
...
static voxgig_value* decrypt_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(decrypt_ent_ctx(self), "SetData");
  }
  feature_hook_util(decrypt_ent_ctx(self), "GetData");
...
static voxgig_value* decrypt_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(decrypt_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(decrypt_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}

static voxgig_value* decrypt_load(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("load", "decrypt");
  return NULL;
}


static void decrypt_list_postdone(decrypt_entity* self, Context* ctx) {
...
static voxgig_value* decrypt_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, decrypt_ent_ctx(self));
  return decrypt_run_op(self, ctx, decrypt_list_postdone, err);
}



static void decrypt_create_postdone(decrypt_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
...
static voxgig_value* decrypt_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, decrypt_ent_ctx(self));
  return decrypt_run_op(self, ctx, decrypt_create_postdone, err);
}


static voxgig_value* decrypt_update(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("update", "decrypt");
  return NULL;
}

static voxgig_value* decrypt_remove(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("remove", "decrypt");
  return NULL;
}
