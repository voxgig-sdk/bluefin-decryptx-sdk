;; BluefinDecryptx SDK DecryptExt entity (generated by @voxgig/sdkgen).
(ns sdk.entity.decrypt_ext
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "decrypt_ext" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "decrypt_ext")
...
;; Canonical facade: (DecryptExt client data) accessor delegates here.
...
;; Create a new DecryptExt (reqdata: body data).
