;; BluefinDecryptx SDK Validation entity (generated by @voxgig/sdkgen).
(ns sdk.entity.validation
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "validation" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "validation")
...
;; Canonical facade: (Validation client data) accessor delegates here.
...
;; Create a new Validation (reqdata: body data).
