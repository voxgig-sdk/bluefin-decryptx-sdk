;; BluefinDecryptx SDK Decrypt entity (generated by @voxgig/sdkgen).
(ns sdk.entity.decrypt
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "decrypt" :_client client :_utility utility :_entopts entopts
...
;; Canonical facade: (Decrypt client data) accessor delegates here.
...
;; List Decrypt items matching a filter (reqmatch: any subset of fields).
...
;; Create a new Decrypt (reqdata: body data).
