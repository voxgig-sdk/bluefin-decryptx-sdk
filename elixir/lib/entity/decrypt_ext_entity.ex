...
defmodule BluefinDecryptx.Entity.DecryptExt do
  ...
  # Returns the created decrypt_ext entity map (BluefinDecryptx.Types.decrypt_ext/0)
  ...
  @spec create(map(), BluefinDecryptx.Types.decrypt_ext_create_data() | nil, map() | nil) :: term()
