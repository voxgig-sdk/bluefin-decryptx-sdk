...
class DecryptExtEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DecryptExtEntity(self._client, opts)
    ...
    def create(self, reqdata: DecryptExtCreateData, ctrl=None) -> DecryptExt:
        utility = self._utility
