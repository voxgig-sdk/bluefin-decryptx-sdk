# BluefinDecryptx SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions BluefinDecryptxSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both BluefinDecryptxSDK(...) and BluefinDecryptxSDK.test(...) become
#      BluefinDecryptxSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "bluefindecryptx_sdk"
_SDK_CLASS = "BluefinDecryptxSDK"
