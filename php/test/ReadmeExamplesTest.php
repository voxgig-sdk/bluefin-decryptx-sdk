...
//      EXECUTED offline in seeded test mode (BluefinDecryptxSDK::test)
...
{
    private const SDK_CLASS = 'BluefinDecryptxSDK';
    ...
    private const SDK_BASE = 'bluefindecryptx_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../bluefindecryptx_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
