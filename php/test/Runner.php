...
class BluefinDecryptxTestRunner
{
    ...
    {
        $live = self::getenv('BLUEFINDECRYPTX_TEST_LIVE');
        $override = self::getenv('BLUEFINDECRYPTX_TEST_OVERRIDE');
        ...
        $explain = self::getenv('BLUEFINDECRYPTX_TEST_EXPLAIN');
...
class_alias('BluefinDecryptxTestRunner', 'Runner');
class_alias('BluefinDecryptxHelpers', 'Helpers');
