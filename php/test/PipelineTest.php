...
// BluefinDecryptx SDK pipeline test
//
...
{
    private static function utility(): BluefinDecryptxUtility
    {
        return new BluefinDecryptxUtility();
    }
    ...
    private static function ctx(array $over = []): BluefinDecryptxContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new BluefinDecryptxContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new BluefinDecryptxOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof BluefinDecryptxError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new BluefinDecryptxOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = BluefinDecryptxMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new BluefinDecryptxOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = BluefinDecryptxMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new BluefinDecryptxOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = BluefinDecryptxMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BluefinDecryptxSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = BluefinDecryptxMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new BluefinDecryptxResponse([]),
            'result' => new BluefinDecryptxResult([]),
        ]);
        [, $err] = BluefinDecryptxMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new BluefinDecryptxSpec([]),
            'response' => null,
            'result' => new BluefinDecryptxResult([]),
        ]);
        [, $err] = BluefinDecryptxMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new BluefinDecryptxSpec(['step' => 's']),
            'response' => new BluefinDecryptxResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new BluefinDecryptxResult([]),
        ]);
        [, $err] = BluefinDecryptxMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new BluefinDecryptxSpec(['step' => 's']),
            'response' => new BluefinDecryptxResponse(self::resp(200, ['v' => 1])),
            'result' => new BluefinDecryptxResult([]),
        ]);
        [, $err] = BluefinDecryptxMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new BluefinDecryptxSpec(['step' => 's']),
            'response' => new BluefinDecryptxResponse(self::resp(200, ['v' => 2])),
            'result' => new BluefinDecryptxResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        BluefinDecryptxMakeResponse::call($ctx);
    ...
    {
        $preset = new BluefinDecryptxResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new BluefinDecryptxSpec([]),
            'response' => new BluefinDecryptxResponse([]),
            'result' => new BluefinDecryptxResult([]),
        ...
        [$got, $err] = BluefinDecryptxMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new BluefinDecryptxResult([])]);
        [, $err] = BluefinDecryptxMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new BluefinDecryptxSpec([]), 'result' => null]);
        [, $err] = BluefinDecryptxMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BluefinDecryptxSpec(['step' => 's']),
            'result' => new BluefinDecryptxResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new BluefinDecryptxOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BluefinDecryptxMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BluefinDecryptxSpec(['step' => 's']),
            'result' => new BluefinDecryptxResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new BluefinDecryptxOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BluefinDecryptxMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BluefinDecryptxResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new BluefinDecryptxSpec([]),
            'result' => new BluefinDecryptxResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = BluefinDecryptxMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BluefinDecryptxMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new BluefinDecryptxError('boom', 'boom');
        $utility->fetcher = function (BluefinDecryptxContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BluefinDecryptxSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = BluefinDecryptxMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (BluefinDecryptxContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = BluefinDecryptxMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(BluefinDecryptxResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        BluefinDecryptxMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (BluefinDecryptxContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BluefinDecryptxSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = BluefinDecryptxMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new BluefinDecryptxResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new BluefinDecryptxSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = BluefinDecryptxMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = BluefinDecryptxMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = BluefinDecryptxMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new BluefinDecryptxResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, BluefinDecryptxDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new BluefinDecryptxResult(['ok' => false])]);
        $this->expectException(BluefinDecryptxError::class);
        BluefinDecryptxDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new BluefinDecryptxResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', BluefinDecryptxMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        BluefinDecryptxMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new BluefinDecryptxBaseFeature();
        $b = new BluefinDecryptxBaseFeature();
        BluefinDecryptxFeatureAdd::call($ctx, $a);
        BluefinDecryptxFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): BluefinDecryptxBaseFeature
    {
        $f = new BluefinDecryptxBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        BluefinDecryptxFeatureAdd::call($ctx, self::named_feature('a'));
        BluefinDecryptxFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        BluefinDecryptxFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        BluefinDecryptxFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        BluefinDecryptxFeatureAdd::call($ctx, $replace);
        ...
        BluefinDecryptxFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): BluefinDecryptxContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new BluefinDecryptxSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BluefinDecryptxPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        BluefinDecryptxPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new BluefinDecryptxResponse(['headers' => null]),
            'result' => new BluefinDecryptxResult([]),
        ]);
        BluefinDecryptxResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        BluefinDecryptxResultBody::call($ctx);
