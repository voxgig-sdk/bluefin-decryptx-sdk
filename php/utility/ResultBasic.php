...
// BluefinDecryptx SDK utility: result_basic

class BluefinDecryptxResultBasic
{
    public static function call(BluefinDecryptxContext $ctx): ?BluefinDecryptxResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof BluefinDecryptxError) ? $result->err->msg : (string)$result->err;
