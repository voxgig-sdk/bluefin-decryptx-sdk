...
class BluefinDecryptxFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; BluefinDecryptxSDK/1.0)';
    ...
    public static function call(BluefinDecryptxContext $ctx, string $fullurl, array $fetchdef): array
    {
