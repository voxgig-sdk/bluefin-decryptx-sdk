...
class DecryptExtEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DecryptExtEntity($this->_client, $opts);
    }

    /**
     * @param DecryptExt|array $args DecryptExt data (assoc-array) to store.
     */
    ...
    /**
     * @return DecryptExt|array The current DecryptExt data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DecryptExt fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DecryptExt fields).
     */
     ...
     *
     * @param DecryptExtCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DecryptExtCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DecryptExt|array The created DecryptExt as an assoc-array at the
