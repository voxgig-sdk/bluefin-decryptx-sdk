...
class ValidationEntity
{
     ...
     *
     * @param ValidationCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ValidationCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Validation|array The created Validation as an assoc-array at the
