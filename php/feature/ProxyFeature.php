...
class BluefinDecryptxProxyFeature extends BluefinDecryptxBaseFeature
{
    ...
    public function init(BluefinDecryptxContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (BluefinDecryptxContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
