...
// BluefinDecryptx SDK rbac feature
...
class BluefinDecryptxRbacFeature extends BluefinDecryptxBaseFeature
{
    ...
    private function _required(BluefinDecryptxContext $ctx): ?string
    {
    ...
    private function _reject(BluefinDecryptxContext $ctx, string $required): void
    {
    ...
    private function _track(BluefinDecryptxContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
