...
class BluefinDecryptxClienttrackFeature extends BluefinDecryptxBaseFeature
{
    ...
    public function PostConstruct(BluefinDecryptxContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'BluefinDecryptx-SDK';
