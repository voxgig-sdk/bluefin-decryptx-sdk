...
// BluefinDecryptx SDK utility type

class BluefinDecryptxUtility
{
    ...
    public static function copy(BluefinDecryptxUtility $src): BluefinDecryptxUtility
    {
        $u = new BluefinDecryptxUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
