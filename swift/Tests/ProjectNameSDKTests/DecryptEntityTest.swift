...
final class DecryptEntityTest: XCTestCase {
  ...
  func testStream() async throws {
    ...
    // items.
    let sdk2 = BluefinDecryptxSDK.testSDK(fixtures, nil)
    let ent2 = sdk2.Decrypt()
    var streamed2: [Value] = []
