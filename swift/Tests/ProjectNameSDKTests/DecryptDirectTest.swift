// decrypt direct API test (generated from the API model).

import XCTest

@testable import BluefinDecryptxSdk

final class DecryptDirectTest: XCTestCase {
  func testDirectMock() {
    ...
    let sdk = BluefinDecryptxSDK(opts)

    let args = VMap()
    args.entries["path"] = .string("/decrypt")
