// BluefinDecryptxEntityBase - shared entity behaviour: construction, data/match
...
open class BluefinDecryptxEntityBase: Entity {
  var name: String
  var client: BluefinDecryptxSDK
  var utility: Utility
  var entopts: VMap
  var data = VMap()
  var match = VMap()
  ...
  public init(_ client: BluefinDecryptxSDK, _ entoptsIn: VMap?, _ name: String) {
  ...
  open func make() -> Entity {
    return BluefinDecryptxEntityBase(client, cloneOpts(), name)
  }
