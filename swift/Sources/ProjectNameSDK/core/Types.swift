// BluefinDecryptx SDK - core contracts.
...
// BluefinDecryptxEntityBase which implements this.
...
// Throws (typically BluefinDecryptxError) on transport-level failure. A returned
