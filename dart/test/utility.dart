...
Map<String, dynamic> envOverride(Map<String, dynamic> m) {
  ...
  if ('TRUE' == env['BLUEFINDECRYPTX_TEST_LIVE'] ||
      'TRUE' == env['BLUEFINDECRYPTX_TEST_OVERRIDE']) {
  ...
  m['BLUEFINDECRYPTX_TEST_EXPLAIN'] =
      env['BLUEFINDECRYPTX_TEST_EXPLAIN'] ?? m['BLUEFINDECRYPTX_TEST_EXPLAIN'];
