...
// Typed models: see ../BluefinDecryptxTypes.dart (DecryptExt and the per-op request/match types).
class DecryptExtEntity extends BluefinDecryptxEntityBase {
  DecryptExtEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'decrypt_ext';
    name_ = 'decrypt_ext';
    Name = 'DecryptExt';
  }

  DecryptExtEntity make() {
    return DecryptExtEntity(client, entopts());
  }




  /// Create a DecryptExt (see DecryptExtCreateData in
  /// BluefinDecryptxTypes.dart). Returns the entity data map (DecryptExt).
