...
import 'dart:async';
import '../utility/ErrUtility.dart';import '../BluefinDecryptxEntityBase.dart';

// Typed models: see ../BluefinDecryptxTypes.dart (Decrypt and the per-op request/match types).
class DecryptEntity extends BluefinDecryptxEntityBase {
  DecryptEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'decrypt';
    name_ = 'decrypt';
    Name = 'Decrypt';
  }
  ...
  DecryptEntity make() {
    return DecryptEntity(client, entopts());
  }



  /// List Decrypt entities by match (see DecryptListMatch in
  /// BluefinDecryptxTypes.dart). Returns a list of Decrypt entity instances.
  ...
  /// Create a Decrypt (see DecryptCreateData in
  /// BluefinDecryptxTypes.dart). Returns the entity data map (Decrypt).
