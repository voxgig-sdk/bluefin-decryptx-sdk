// BluefinDecryptxSDK client (generated — mirrors the go/rust Main fragment).
...
pub const BluefinDecryptxSDK = struct {
    mode: []const u8 = "live",
    options: Value = .{ .null = {} },
    utility: *Utility,
    ...
    pub fn new(options: Value) *BluefinDecryptxSDK {
        const sdk = h.A().create(BluefinDecryptxSDK) catch unreachable;
        sdk.* = .{
            .mode = "live",
            .options = h.vnull(),
            .utility = Utility.new(),
    ...
    pub fn options_map(self: *BluefinDecryptxSDK) Value {
        return h.clone(self.options);
    }

    pub fn get_utility(self: *BluefinDecryptxSDK) *Utility {
        return Utility.copy(self.utility);
    }

    pub fn get_root_ctx(self: *BluefinDecryptxSDK) *Context {
        return self.rootctx orelse unreachable;
    }

    pub fn prepare(self: *BluefinDecryptxSDK, fetchargs_in: Value) E!Value {
    ...
    pub fn direct(self: *BluefinDecryptxSDK, fetchargs_in: Value) Value {
        const utility = self.utility;
    ...
    pub fn decrypt(self: *@This(), entopts: Value) *@import("../entity/decrypt.zig").DecryptEntity {
        return @import("../entity/decrypt.zig").DecryptEntity.new(self, entopts);
    }

    /// DecryptExt entity bound to this client.
    pub fn decrypt_ext(self: *@This(), entopts: Value) *@import("../entity/decrypt_ext.zig").DecryptExtEntity {
        return @import("../entity/decrypt_ext.zig").DecryptExtEntity.new(self, entopts);
    }

    /// Validation entity bound to this client.
    pub fn validation(self: *@This(), entopts: Value) *@import("../entity/validation.zig").ValidationEntity {
        return @import("../entity/validation.zig").ValidationEntity.new(self, entopts);
    }

};

pub fn test_sdk(testopts_in: Value, sdkopts_in: Value) *BluefinDecryptxSDK {
    ...
    const sdk = BluefinDecryptxSDK.new(sdkopts);
    sdk.mode = "test";
