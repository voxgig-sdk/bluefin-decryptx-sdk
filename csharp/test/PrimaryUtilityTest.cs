...
public class PrimaryUtilityTest
{
    ...
    private readonly BluefinDecryptxSDK _client;
    ...
    public PrimaryUtilityTest()
    {
        ...
        _client = BluefinDecryptxSDK.TestSDK(null, null);
        _utility = _client.GetUtility();
    }

    // Helper: create basic test context.
    private Context MakeTestCtx(BluefinDecryptxSDK client, Utility utility,
    ...
    private Context MakeTestFullCtx(BluefinDecryptxSDK client, Utility utility)
    {
    ...
    {
        var hookClient = BluefinDecryptxSDK.TestSDK(null, null);
    ...
    {
        var initClient = BluefinDecryptxSDK.TestSDK(null, null);
    ...
    public void FetcherLive()
    {
        ...
        var liveClient = new BluefinDecryptxSDK(new Dictionary<string, object?>
        {
    ...
    public void FetcherBlockedTestMode()
    {
        ...
        var blockedClient = new BluefinDecryptxSDK(new Dictionary<string, object?>
        {
            ["system"] = new Dictionary<string, object?>
            {
                ["fetch"] = (Func<string, Dictionary<string, object?>, Dictionary<string, object?>>)
    ...
    public void MakeSpecBasic()
    {
        ...
        var specClient = BluefinDecryptxSDK.TestSDK(null, setupOpts);
    ...
    public void PrepareAuthBasic()
    {
        ...
        var authClient = BluefinDecryptxSDK.TestSDK(null, setupOpts);
