// BluefinDecryptx SDK test runner - shared infrastructure for the generated
...
{
    public BluefinDecryptxSDK Client = null!;
...
public static class TestRunner
{
    ...
    {
        if (Environment.GetEnvironmentVariable("BLUEFINDECRYPTX_TEST_LIVE") == "TRUE" ||
            Environment.GetEnvironmentVariable("BLUEFINDECRYPTX_TEST_OVERRIDE") == "TRUE")
        {
        ...
        var explain = Environment.GetEnvironmentVariable("BLUEFINDECRYPTX_TEST_EXPLAIN");
    ...
    public static int LiveDelayMs()
    {
        ...
        {
            var n = BluefinDecryptxSdk.Helpers.ToInt(v);
            if (n >= 0)
            {
                return n;
            }
    ...
    public static Context MakeCtxFromMap(Dictionary<string, object?>? ctxmap,
        BluefinDecryptxSDK? client, Utility? utility)
    {
            ...
            resRaw is Dictionary<string, object?> resMap)
        {
            ...
            {
                ctx.Result.Err = new BluefinDecryptxError("", msg, null);
            }
        }
    ...
    public static void FixCtx(Context ctx, BluefinDecryptxSDK client)
    {
    ...
    public static Exception? ErrFromMap(Dictionary<string, object?>? m)
    {
        ...
        return new BluefinDecryptxError(code, msg, null);
    }
