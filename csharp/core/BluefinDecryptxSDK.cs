// BluefinDecryptx SDK client.

using Voxgig.Struct;

using BluefinDecryptxSdk.Feature;

namespace BluefinDecryptxSdk;

public class BluefinDecryptxSDK
{
    ...
    public BluefinDecryptxSDK(Dictionary<string, object?>? options = null)
    {
    ...
    // Decrypt returns a Decrypt entity bound to this client.
    // Idiomatic usage: client.Decrypt().List(null) or
    // client.Decrypt().Load(new() { ["id"] = ... }).
    public BluefinDecryptxEntityBase Decrypt(Dictionary<string, object?>? entopts = null)
    {
        return new global::BluefinDecryptxSdk.Entity.DecryptEntity(this, entopts);
    }

    // DecryptExt returns a DecryptExt entity bound to this client.
    // Idiomatic usage: client.DecryptExt().List(null) or
    // client.DecryptExt().Load(new() { ["id"] = ... }).
    public BluefinDecryptxEntityBase DecryptExt(Dictionary<string, object?>? entopts = null)
    {
        return new global::BluefinDecryptxSdk.Entity.DecryptExtEntity(this, entopts);
    }

    // Validation returns a Validation entity bound to this client.
    // Idiomatic usage: client.Validation().List(null) or
    // client.Validation().Load(new() { ["id"] = ... }).
    public BluefinDecryptxEntityBase Validation(Dictionary<string, object?>? entopts = null)
    {
        return new global::BluefinDecryptxSdk.Entity.ValidationEntity(this, entopts);
    }


    public static BluefinDecryptxSDK TestSDK(Dictionary<string, object?>? testopts,
        Dictionary<string, object?>? sdkopts)
    {
        ...
        var sdk = new BluefinDecryptxSDK(sdkopts)
        {
            Mode = "test",
        };
