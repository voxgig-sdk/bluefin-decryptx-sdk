...
public abstract class BluefinDecryptxEntityBase : IEntity
{
    protected string name;
    protected BluefinDecryptxSDK client;
    ...
    protected BluefinDecryptxEntityBase(BluefinDecryptxSDK client,
