...
public class DecryptEntity : BluefinDecryptxEntityBase
{
    public DecryptEntity(BluefinDecryptxSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "decrypt")
    {
    }

    public override IEntity Make()
    {
        return new DecryptEntity(client, CloneOpts());
    }
