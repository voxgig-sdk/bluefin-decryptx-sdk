...
public class DecryptExtEntity : BluefinDecryptxEntityBase
{
    public DecryptExtEntity(BluefinDecryptxSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "decrypt_ext")
    {
    }

    public override IEntity Make()
    {
        return new DecryptExtEntity(client, CloneOpts());
    }
