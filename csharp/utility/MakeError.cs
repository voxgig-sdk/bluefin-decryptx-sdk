// BluefinDecryptx SDK utility: makeError - the single error surface of the
// pipeline. Throws the wrapped BluefinDecryptxError unless the per-call ctrl
// disables throwing (ctrl.throw == false), in which case it returns the
// (possibly nil) result data instead.

namespace BluefinDecryptxSdk.Util;
...
public static partial class SdkUtility
{
    internal static object? MakeErrorUtil(Context ctx, Exception? err)
    {
        ...
        var msg = "BluefinDecryptxSDK: " + opname + ": " + errmsg;
        ...
        var sdkErr = new BluefinDecryptxError(
            err is BluefinDecryptxError se ? se.Code : "", msg, ctx)
        {
