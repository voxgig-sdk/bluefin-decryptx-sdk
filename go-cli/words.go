...
func registerSDKWords(r *eng.Registry, client *sdk.BluefinDecryptxSDK) {
...
func runOp(client *sdk.BluefinDecryptxSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
