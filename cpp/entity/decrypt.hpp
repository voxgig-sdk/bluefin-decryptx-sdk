// Decrypt entity client (generated). Shared entity runtime (data/match
...
class DecryptEntity : public EntityBase {
public:
  DecryptEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("decrypt", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<DecryptEntity>(this->client, opts);
  }
