// Validation entity client (generated). Shared entity runtime (data/match
...
class ValidationEntity : public EntityBase {
public:
  ValidationEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("validation", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<ValidationEntity>(this->client, opts);
  }
