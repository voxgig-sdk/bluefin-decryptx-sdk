// Runtime test suite for the BluefinDecryptx SDK — a dependency-free scala-cli
...
import voxgig.bluefindecryptxsdk.core._
import voxgig.bluefindecryptxsdk.feature._
...
object SdkTestMain {
  ...
  final class FhHarness {
    var client: BluefinDecryptxSDK = null
