...
import voxgig.bluefindecryptxsdk.core.{Context, Entity, Helpers, SdkClient}
import voxgig.bluefindecryptxsdk.utility.struct.Struct

// Validation entity client for the BluefinDecryptx SDK.
class ValidationEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("validation", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new ValidationEntity(this.client, opts)
  }
