...
class DecryptExtEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("decrypt_ext", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new DecryptExtEntity(this.client, opts)
  }
