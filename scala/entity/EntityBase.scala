...
import voxgig.bluefindecryptxsdk.core.{Context, Helpers, SdkClient, SdkEntity, Utility}
import voxgig.bluefindecryptxsdk.utility.struct.Struct

// Shared entity runtime for the BluefinDecryptx SDK: accreting data/match state,
