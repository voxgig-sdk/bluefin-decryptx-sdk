...
class Utility private (noregister: Boolean) {
  ...
  val struct: voxgig.bluefindecryptxsdk.utility.StructUtility.type = voxgig.bluefindecryptxsdk.utility.StructUtility

  def this() = {
    this(false)
    voxgig.bluefindecryptxsdk.utility.Register.registerAll(this)
  }
