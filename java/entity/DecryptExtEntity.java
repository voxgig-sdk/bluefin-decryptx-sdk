...
public class DecryptExtEntity extends EntityBase {

  public DecryptExtEntity(SdkClient client, Map<String, Object> entopts) {
    super("decrypt_ext", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new DecryptExtEntity(this.client, opts);
  }
