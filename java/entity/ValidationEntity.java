...
public class ValidationEntity extends EntityBase {

  public ValidationEntity(SdkClient client, Map<String, Object> entopts) {
    super("validation", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new ValidationEntity(this.client, opts);
  }
