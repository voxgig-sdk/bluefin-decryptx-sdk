...
#      offline in seeded test mode (BluefinDecryptxSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "BluefinDecryptx_sdk.rb")
  SDK_CLASS = "BluefinDecryptxSDK"
