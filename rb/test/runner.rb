...
module BluefinDecryptxTestRunner
  @env = {}
  ...
  def self.env_override(m)
    live = getenv("BLUEFINDECRYPTX_TEST_LIVE")
    override = getenv("BLUEFINDECRYPTX_TEST_OVERRIDE")
    ...
    explain = getenv("BLUEFINDECRYPTX_TEST_EXPLAIN")
    m["BLUEFINDECRYPTX_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = BluefinDecryptxTestRunner
Helpers = BluefinDecryptxHelpers
Vs = VoxgigStruct
