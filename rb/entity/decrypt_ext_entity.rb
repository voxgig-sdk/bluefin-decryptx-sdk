...
class DecryptExtEntity
  ...
  def make
    opts = @_entopts.dup
    DecryptExtEntity.new(@_client, opts)
  end
  ...
  # @return [DecryptExt, Hash] the current DecryptExt data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of DecryptExt fields)
  def match_get
  ...
  #
  # @param reqdata [DecryptExtCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [DecryptExt, Hash] the created DecryptExt; raises BluefinDecryptxError on failure
