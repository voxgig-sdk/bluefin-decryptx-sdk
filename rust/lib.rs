// BluefinDecryptx SDK for Rust (generated by @voxgig/sdkgen).
//
...
pub use crate::core::error::BluefinDecryptxError;
...
pub use crate::core::sdk::{test_sdk, BluefinDecryptxSDK};
pub use crate::core::spec::Spec;
pub use crate::core::types::{
    Entity, Feature, FeatureRef, FetcherFn, OutVal, BluefinDecryptxEntity,
};
...
// No-argument convenience constructors: `bluefin_decryptx_sdk::new()` /
// `bluefin_decryptx_sdk::test()` for the common no-options case.
use std::rc::Rc;

pub fn new() -> Rc<BluefinDecryptxSDK> {
    BluefinDecryptxSDK::new(Value::Noval)
}

pub fn test() -> Rc<BluefinDecryptxSDK> {
