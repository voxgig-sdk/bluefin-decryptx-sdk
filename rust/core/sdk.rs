// BluefinDecryptxSDK client (generated — mirrors the go Main fragment).
...
impl BluefinDecryptxSDK {
    pub fn new(options: Value) -> Rc<BluefinDecryptxSDK> {
        let sdk = Rc::new(BluefinDecryptxSDK {
    ...
    pub fn prepare(&self, fetchargs: Value) -> Result<Value, BluefinDecryptxError> {
    ...
    pub fn direct(&self, fetchargs: Value) -> Result<Value, BluefinDecryptxError> {
        let utility = &self.utility;
    ...
    pub fn decrypt(self: &Rc<Self>, entopts: Value) -> Rc<crate::entity::decrypt::DecryptEntity> {
        crate::entity::decrypt::DecryptEntity::new(self, entopts)
    }

    /// DecryptExt entity bound to this client.
    pub fn decrypt_ext(self: &Rc<Self>, entopts: Value) -> Rc<crate::entity::decrypt_ext::DecryptExtEntity> {
        crate::entity::decrypt_ext::DecryptExtEntity::new(self, entopts)
    }

    /// Validation entity bound to this client.
    pub fn validation(self: &Rc<Self>, entopts: Value) -> Rc<crate::entity::validation::ValidationEntity> {
        crate::entity::validation::ValidationEntity::new(self, entopts)
    }

}

pub fn test_sdk(testopts: Value, sdkopts: Value) -> Rc<BluefinDecryptxSDK> {
    ...
    let sdk = BluefinDecryptxSDK::new(sdkopts);
    *sdk.mode.borrow_mut() = "test".to_string();
