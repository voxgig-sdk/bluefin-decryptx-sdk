// Decrypt entity client (generated — mirrors the go Entity fragment).
...
impl DecryptEntity {
    pub fn new(client: &Rc<BluefinDecryptxSDK>, entopts: Value) -> Rc<DecryptEntity> {
...
impl Entity for DecryptEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        DecryptEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinDecryptxEntity for DecryptEntity {
    ...
    fn list(&self, reqmatch: Value, ctrl: Value) -> Result<Value, BluefinDecryptxError> {
        let ctx = self.utility.make_context(
            CtxSpec {
