// Validation entity client (generated — mirrors the go Entity fragment).
...
impl ValidationEntity {
    pub fn new(client: &Rc<BluefinDecryptxSDK>, entopts: Value) -> Rc<ValidationEntity> {
...
impl Entity for ValidationEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        ValidationEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinDecryptxEntity for ValidationEntity {
