#!perl
# BluefinDecryptx SDK - documentation example COMPLETENESS gate.
#
...
#      (BluefinDecryptxSDK->test) against the real SDK. Captured output is scanned for
...
my $SDK_CLASS = 'BluefinDecryptxSDK';
...
# becomes BluefinDecryptxSDK->test(<fixtures>); a block that only uses $client gets
