# BluefinDecryptx SDK utility: transform_response
...
$REGISTRY{transform_response} = sub {
  ...
  my $resform = BluefinDecryptxHelpers::gp($transform, 'res');
  return undef unless BluefinDecryptxHelpers::rb_truthy($resform);
