# BluefinDecryptx SDK Validation entity
...
# Returns the current Validation data (hashref).
sub data_get {
  my ($self) = @_;
...
# Returns the current match filter (any subset of Validation fields).
sub match_get {
  my ($self) = @_;
...
#
# reqdata: body data hashref (ValidationCreateData shape). ctrl: optional
# per-call control. Returns the created Validation data (hashref); dies
