...
describe('DecryptDirect', async () => {
  ...
  test('direct-list-decrypt', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-decrypt', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['BLUEFINDECRYPTX_TEST_DECRYPT_ENTID']
