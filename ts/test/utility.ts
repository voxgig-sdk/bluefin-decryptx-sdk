...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.BLUEFINDECRYPTX_TEST_LIVE ||
    'TRUE' === process.env.BLUEFINDECRYPTX_TEST_OVERRIDE
  ) {
  ...
  m.BLUEFINDECRYPTX_TEST_EXPLAIN = process.env.BLUEFINDECRYPTX_TEST_EXPLAIN || m.BLUEFINDECRYPTX_TEST_EXPLAIN
