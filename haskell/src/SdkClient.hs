-- BluefinDecryptx SDK public client (generated by @voxgig/sdkgen).
--
...
-- | The Decrypt entity bound to this client.
decrypt :: Client -> Value -> IO Entity
decrypt client entopts = F.makeEntity client "decrypt" entopts

-- | The DecryptExt entity bound to this client.
decrypt_ext :: Client -> Value -> IO Entity
decrypt_ext client entopts = F.makeEntity client "decrypt_ext" entopts

-- | The Validation entity bound to this client.
validation :: Client -> Value -> IO Entity
validation client entopts = F.makeEntity client "validation" entopts
