...
let rec make (client : sdk_client) (entopts_in : value) : entity_obj =
  ...
  ent.e_load <- (fun _ _ ->
      raise (Sdk_error_exc (mk_error "unsupported_op"
        "Operation \"load\" not supported by entity \"validation\".")));
  ent.e_list <- (fun _ _ ->
      raise (Sdk_error_exc (mk_error "unsupported_op"
        "Operation \"list\" not supported by entity \"validation\".")));
  ...
  ent.e_update <- (fun _ _ ->
      raise (Sdk_error_exc (mk_error "unsupported_op"
        "Operation \"update\" not supported by entity \"validation\".")));
  ent.e_remove <- (fun _ _ ->
      raise (Sdk_error_exc (mk_error "unsupported_op"
        "Operation \"remove\" not supported by entity \"validation\".")));
  ent
