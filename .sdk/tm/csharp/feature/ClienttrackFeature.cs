...
using static BluefinDecryptxSdk.Feature.FeatureOptions;

namespace BluefinDecryptxSdk.Feature;

public class ClienttrackFeature : BaseFeature
{
    private BluefinDecryptxSDK? _client;
    ...
    {
        var name = FoptStr(_options, "clientName", "BluefinDecryptx-SDK");
