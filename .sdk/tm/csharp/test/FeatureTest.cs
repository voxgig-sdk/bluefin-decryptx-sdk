...
internal static class Fh
{
    ...
    {
        return err is BluefinDecryptxError se ? se.Code : "";
    }
}
...
public class FeaturePagingTest
{
    ...
    public void StampsPageLimitAndReadsHeaders()
    {
        ...
        Assert.Equal(2, BluefinDecryptxSdk.Helpers.ToInt(paging["nextPage"]));
        Assert.Equal(5, BluefinDecryptxSdk.Helpers.ToInt(paging["totalCount"]));
