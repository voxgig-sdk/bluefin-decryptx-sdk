# BluefinDecryptx SDK core runtime objects.
#
...
defmodule BluefinDecryptx.Control do
...
defmodule BluefinDecryptx.Spec do
  alias Voxgig.Struct, as: S
...
defmodule BluefinDecryptx.Result do
  alias Voxgig.Struct, as: S
...
defmodule BluefinDecryptx.Response do
  alias Voxgig.Struct, as: S
...
defmodule BluefinDecryptx.Operation do
  alias Voxgig.Struct, as: S
