...
final class PrimaryUtilityTest: XCTestCase {
  ...
  private var client: BluefinDecryptxSDK!
  private var utility: Utility!

  override func setUp() {
    super.setUp()
    primary = SdkRunner.loadPrimary()
    client = BluefinDecryptxSDK.testSDK(nil, nil)
  ...
  private func makeTestCtx(_ client: BluefinDecryptxSDK, _ utility: Utility,
  ...
  private func makeTestFullCtx(_ client: BluefinDecryptxSDK, _ utility: Utility) -> Context {
  ...
  func testFeatureHookBasic() {
    let hookClient = BluefinDecryptxSDK.testSDK(nil, nil)
  ...
  func testFeatureInitBasic() {
    let initClient = BluefinDecryptxSDK.testSDK(nil, nil)
  ...
  func testFetcherLive() throws {
    ...
    let liveClient = BluefinDecryptxSDK(opts)
  ...
  func testFetcherBlockedTestMode() {
    ...
    let opts = VMap()
    opts.entries["system"] = .map(vm(("fetch", .nat(fetch))))
    let blockedClient = BluefinDecryptxSDK(opts)
  ...
  func testMakeSpecBasic() {
    ...
    let specClient = BluefinDecryptxSDK.testSDK(nil, setupOpts)
  ...
  func testPrepareAuthBasic() {
    ...
    let authClient = BluefinDecryptxSDK.testSDK(nil, setupOpts)
