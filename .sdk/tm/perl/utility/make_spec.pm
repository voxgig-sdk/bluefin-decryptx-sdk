# BluefinDecryptx SDK utility: make_spec
...
$REGISTRY{make_spec} = sub {
  ...
  my $base = BluefinDecryptxHelpers::gp($options, 'base');
  $base = '' unless defined $base;
  my $prefix = BluefinDecryptxHelpers::gp($options, 'prefix');
  $prefix = '' unless defined $prefix;
  my $suffix = BluefinDecryptxHelpers::gp($options, 'suffix');
  $suffix = '' unless defined $suffix;

  my $parts = [];
  $parts = BluefinDecryptxHelpers::gp($point, 'parts') if $point;
  ...
  my $allow_method = BluefinDecryptxHelpers::gpath($options, 'allow.method');
