...
class BluefinDecryptxStreamingFeature extends BluefinDecryptxBaseFeature
{
    ...
    private function _iterate(BluefinDecryptxResult $result): \Generator
    {
    ...
    private function _streamable(BluefinDecryptxContext $ctx): bool
    {
