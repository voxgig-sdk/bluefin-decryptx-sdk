...
// BluefinDecryptx SDK cache feature
...
class BluefinDecryptxCacheFeature extends BluefinDecryptxBaseFeature
{
    ...
    private function _through(BluefinDecryptxContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
