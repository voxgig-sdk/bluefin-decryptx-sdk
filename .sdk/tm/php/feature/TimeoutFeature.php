...
// BluefinDecryptx SDK timeout feature
...
class BluefinDecryptxTimeoutFeature extends BluefinDecryptxBaseFeature
{
    ...
    private function _with_timeout(BluefinDecryptxContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(BluefinDecryptxContext $_ctx, float $ms): void
    {
        $client = $this->client;
