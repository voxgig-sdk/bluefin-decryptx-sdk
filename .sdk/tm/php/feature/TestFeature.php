...
class BluefinDecryptxTestFeature extends BluefinDecryptxBaseFeature
{
    ...
    public function init(BluefinDecryptxContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (BluefinDecryptxContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = BluefinDecryptxParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (BluefinDecryptxContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(BluefinDecryptxContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = BluefinDecryptxParam::call($ctx, $k);
