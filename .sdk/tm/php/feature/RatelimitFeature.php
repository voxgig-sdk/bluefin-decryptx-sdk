...
// BluefinDecryptx SDK ratelimit feature
...
class BluefinDecryptxRatelimitFeature extends BluefinDecryptxBaseFeature
{
    ...
    private function _acquire(BluefinDecryptxContext $ctx): void
    {
    ...
    private function _track(BluefinDecryptxContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
