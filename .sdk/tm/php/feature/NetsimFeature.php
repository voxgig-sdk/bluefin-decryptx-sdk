...
// BluefinDecryptx SDK netsim feature
...
class BluefinDecryptxNetsimFeature extends BluefinDecryptxBaseFeature
{
    ...
    private function _simulate(BluefinDecryptxContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(BluefinDecryptxContext $ctx, array $applied): void
    {
        $client = $this->client;
