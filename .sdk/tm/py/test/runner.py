...
class BluefinDecryptxTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = BluefinDecryptxTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = BluefinDecryptxTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = BluefinDecryptxTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
