...
from core.control import BluefinDecryptxControl
...
class BluefinDecryptxContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = BluefinDecryptxControl()
        ...
        if isinstance(sp, BluefinDecryptxSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, BluefinDecryptxResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, BluefinDecryptxResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return BluefinDecryptxOperation({})
    ...
    def make_error(self, code, msg):
        return BluefinDecryptxError(code, msg, self)
