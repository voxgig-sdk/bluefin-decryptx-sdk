// Shared Value helpers for the BluefinDecryptx SDK pipeline. The SDK data model
...
// underlying API spec doesn't define. The static BluefinDecryptxEntity trait
...
pub fn unsupported_op(opname: &str, entityname: &str) -> BluefinDecryptxError {
    BluefinDecryptxError::new(
        "unsupported_op",
        &format!(
