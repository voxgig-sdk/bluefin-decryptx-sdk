...
import voxgig.bluefindecryptxsdk.sdktest.RunnerSupport.getSpec
import voxgig.bluefindecryptxsdk.sdktest.RunnerSupport.loadTestSpec
import voxgig.bluefindecryptxsdk.sdktest.RunnerSupport.makeCtxFromMap
import voxgig.bluefindecryptxsdk.sdktest.RunnerSupport.runset
...
class PrimaryUtilityTest {
  ...
  private fun client(): BluefinDecryptxSDK = BluefinDecryptxSDK.testSDK()

  private fun makeTestCtx(client: BluefinDecryptxSDK, utility: Utility, overrides: MutableMap<String, Any?>?): Context {
  ...
  private fun makeTestFullCtx(client: BluefinDecryptxSDK, utility: Utility): Context {
  ...
  fun fetcherLive() {
    ...
    val liveClient = BluefinDecryptxSDK(
      fhMap(
        "system",
        fhMap(
          "fetch",
  ...
  fun fetcherBlockedTestMode() {
    val blockedClient = BluefinDecryptxSDK(
      fhMap(
        "system",
  ...
  fun makeSpecBasic() {
    ...
    val specClient = BluefinDecryptxSDK.testSDK(null, setupOpts)
  ...
  fun prepareAuthBasic() {
    ...
    val authClient = BluefinDecryptxSDK.testSDK(null, setupOpts)
