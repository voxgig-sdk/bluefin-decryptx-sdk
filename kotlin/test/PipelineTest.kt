...
class PipelineTest {
  ...
  private fun plClient(sdkopts: MutableMap<String, Any?>?): BluefinDecryptxSDK {
    return BluefinDecryptxSDK.testSDK(null, sdkopts)
  }

  private fun plCtx(client: BluefinDecryptxSDK, utility: Utility, ctrl: MutableMap<String, Any?>?): Context {
  ...
  private fun names(client: BluefinDecryptxSDK): String {
