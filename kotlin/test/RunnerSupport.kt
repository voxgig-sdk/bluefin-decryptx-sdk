...
object RunnerSupport {
  ...
  fun envOverride(m: MutableMap<String, Any?>): MutableMap<String, Any?> {
    if ("TRUE" == getenv("BLUEFINDECRYPTX_TEST_LIVE") || "TRUE" == getenv("BLUEFINDECRYPTX_TEST_OVERRIDE")) {
    ...
    val explain = getenv("BLUEFINDECRYPTX_TEST_EXPLAIN")
  ...
  class EntityTestSetup {
    lateinit var client: BluefinDecryptxSDK
  ...
  fun makeCtxFromMap(ctxmapIn: MutableMap<String, Any?>?, client: BluefinDecryptxSDK?, utility: Utility?): Context {
  ...
  fun fixctx(ctx: Context?, client: BluefinDecryptxSDK?) {
