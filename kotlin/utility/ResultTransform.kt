...
fun resultBasic(ctx: Context): voxgig.bluefindecryptxsdk.core.Result {
...
fun resultBody(ctx: Context): voxgig.bluefindecryptxsdk.core.Result {
  val response = ctx.response
  val result = ctx.result
...
fun resultHeaders(ctx: Context): voxgig.bluefindecryptxsdk.core.Result {
  val response = ctx.response
  val result = ctx.result
